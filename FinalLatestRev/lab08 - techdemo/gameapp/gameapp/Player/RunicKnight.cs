...
namespace Engine
{
    public class RunicKnight : Player
    {
        ...
        public RunicKnight(GamePadState cCont, GamePadState pCont, string index, ContentManager _Content) 
        {
            ...
            _critChance = .05f;
            classSpriteWalking = new SpriteSheet("playerSprites/RunicKnightWalking",1,2,new Vector2(96,96), 140, _Content);
            classSpriteIdle = new Sprite("playerSprites/RunicKnight", new Vector2(96, 96), _Content);
