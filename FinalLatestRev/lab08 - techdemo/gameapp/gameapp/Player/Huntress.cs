...
namespace Engine
{
    public class Huntress : Player
    {
        ...
        public Huntress(GamePadState cCont, GamePadState pCont, string index, ContentManager _Content)
        {
            ...
            _critChance = .05f;
            classSpriteWalking = new SpriteSheet("playerSprites/HuntressWalking", 1, 2, new Vector2(96, 96), 140, _Content);
            classSpriteIdle = new Sprite("playerSprites/Huntress", new Vector2(96, 96), _Content);
