...
namespace Engine
{
    public class Dragon : Player
    {
        ...
        public Dragon(GamePadState cCont, GamePadState pCont, string index, ContentManager _Content)
        {
            ...
            _critChance = .05f;
            classSpriteWalking = new SpriteSheet("playerSprites/DragonBorneWalking", 1, 2, new Vector2(96, 96), 140, _Content);
            classSpriteIdle = new Sprite("playerSprites/DragonBorne", new Vector2(96, 160), _Content);
